#!/usr/bin/env bash
# =============================================================================
# Inference on mm10-minus variant genomes using Borzoi fine-tuned (FM) model
#
# Same mm10-minus genomes as in run_mm10_minus_inference.sh, but using the
# Borzoi foundation model fine-tuned on mm10 (borzoi_finetuned_rf524k config).
#
# Usage:
#   ./run_mm10_minus_inference_fm.sh
#   ./run_mm10_minus_inference_fm.sh mm10MinusCGD
# =============================================================================
...
CONFIG="${SCRIPT_DIR}/../configs/borzoi_finetuned_rf/borzoi_finetuned_rf524k.yaml"
...
run_inference() {
    ...
    local output_dir="${PREDICTIONS_BASE}/fm_rf524k_${variant}"
    local track_prefix="seq.IQ.pcg.fm.${variant}.rf524k_"
